...
% (79.4 PRO) 
beats dedicated AS methods
% WinCLIP (64.6) and DIVAD (73.3) 
but falls short of the state-of-art (see Table 2 in paper)% FADE (84.5)
.
...
\noindent Addressing \R1 and \R4, we ablate data scale and architecture under a fixed 200k-iteration budget (Tab.~\ref{tab:data_arch_ablation}). 
