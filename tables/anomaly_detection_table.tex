...
\color{gray} DIVAD    & \color{gray}\cite{hicsonmez2026training}& \color{gray} \cmark & \color{gray}\underline{88.0}    & \color{gray}72.5    & \color{gray}35.5   & \color{gray}\textbf{93.4}   & \color{gray}78.2   & \color{gray}\textbf{24.0}   \\
