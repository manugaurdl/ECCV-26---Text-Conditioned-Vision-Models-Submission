...
High quality unpaired vision-only and language-only data vastly exceed paired high quality multimodal data; our approach leverages this asymmetry by preserving the representational depth learned from each modality independently.
