...
Our method steers global features with text, achieving 93.6\% and 91.3\% on indoor and outdoor scenes.
}
...
\centering
\includegraphics[width=\textwidth]{old_figures/dinov2_attn_maps.pdf}
...
We observe an optimal operating point at a scaling factor of 0.6: the model preserves the foundational feature quality of DINOv2 while unlocking high text steerability, outperforming both standard encoders and models like SAM3 and GroundingDINO. \MG{knob helps with siglip specifically}
...
\centering
% \includegraphics[width=\textwidth]{old_figures/ca_gate_cos_sim.pdf}
...
\centering
\includegraphics[width=\textwidth]{old_figures/ca_gate_mosaic.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\textwidth]{old_figures/eccv_pods.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{old_figures/tsne_semantic.pdf}
