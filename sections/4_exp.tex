...
\subsubsection{Conditioning on Random Object Class}.
...
We observe an optimal operating point at a scaling factor of 0.6: the model preserves the foundational feature quality of DINOv2 while unlocking high text steerability, outperforming both standard encoders and models like SAM3 and GroundingDINO. \MLLM{knob helps with siglip specifically}
