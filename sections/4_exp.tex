...
\caption{\textbf{Text routes dense attention.} Attention maps on a four-image mosaic; text conditioning redirects self-attention from salient objects to the queried concept whereas DINOv2 attends to the most salient objects ().
\MT{retouch figures}
}
