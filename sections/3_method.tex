...
\vspace{-2mm}
\caption{\textbf{Steering ViTs using text conditioning.}
Our method adds lightweight vision$\rightarrow$language cross-attention layers within pretrained ViT blocks and applies a patch-level segmentation proxy objective to fuse prompt cues into patch tokens.
\MG{we train with softCE}
}
