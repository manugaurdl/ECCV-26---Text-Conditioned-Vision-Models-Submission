...
- **Gated cross-attention**: Flamingo-style tanh-gated dense cross-attention
...
- **Steerable but degraded**: SAM3, GroundingDINO
...
- ** motivate the question the subsection is asking, explore the question and experimental setup, then weave a story describing the results
...
- **Findings**: should be written with brevity, should have high level takeaways, findings should have a linear storytelling flow 
